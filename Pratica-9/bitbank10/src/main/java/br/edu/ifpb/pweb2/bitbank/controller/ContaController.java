...
public class ContaController {
    ...
    @GetMapping("/nuconta")
    public ModelAndView getNuConta(ModelAndView modelAndView) {
    ...
    public ModelAndView operacaoConta(@RequestParam("nuConta") String nuConta,  @ModelAttribute("transacao") Transacao transacao, ModelAndView modelAndView) {
    ...
    @PostMapping
    public ModelAndView adicioneConta(@Valid Conta conta, BindingResult result, ModelAndView modelAndView, RedirectAttributes redirectAttributes) {
    ...
    @GetMapping("/{id}/edit")
    public ModelAndView ediContaById(@PathVariable("id") Integer id, ModelAndView modelAndView, RedirectAttributes redirectAttributes) {
        Conta conta = contaService.findById(id);
        modelAndView.addObject("conta", conta);
        redirectAttributes.addFlashAttribute("mensagem", "Conta editada com sucesso!");
        modelAndView.setViewName("contas/form");
        return modelAndView;
    }
    @GetMapping("/{id}/delete")
    public ModelAndView deleteContaByID(@PathVariable("id") Integer id, ModelAndView modelAndView, RedirectAttributes redirectAttributes) {
        contaService.deleteById(id);
        redirectAttributes.addFlashAttribute("mensagem", "Conta deletada com sucesso!");
        modelAndView.setViewName("redirect:/contas");
        return modelAndView;
